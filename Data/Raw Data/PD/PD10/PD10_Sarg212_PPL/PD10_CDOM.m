...
[T0_A,wvln,T0_Atime] = readupath('PD10_T0_A.TXT');
[T0_B,wvln,T0_Btime] = readupath('PD10_T0_B.TXT');
[T0_C,wvln,T0_Ctime] = readupath('PD10_T0_C.TXT');

[Light_T1_A,wvln,Light_T1_Atime] = readupath('PD10_L_T1_A.TXT');
[Light_T1_B,wvln,Light_T1_Btime] = readupath('PD10_L_T1_B.TXT');
[Light_T1_C,wvln,Light_T1_Ctime] = readupath('PD10_L_T1_C.TXT');


[Dark_T1_A,wvln,Dark_T1_Atime] = readupath('PD10_D_T1_A.TXT');
[Dark_T1_B,wvln,Dark_T1_Btime] = readupath('PD10_D_T1_B_2.TXT');
...
PD10_Sarg21_2_PPL_CDOM = table(wvln_2, T0_A_ag, T0_B_ag, T0_C_ag, Light_T1_A_ag, Light_T1_B_ag, Light_T1_C_ag, Dark_T1_A_ag, Dark_T1_B_ag);
